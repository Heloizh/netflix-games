          ...
          <div className="flex">
            <div className="p-10 md:mt-16 md:p-20">
              ...
              <h5 className="text-xs mt-10 mr-56 md:mr-16 md:text-xl">
                Discover a world where gaming knows no limits. From timeless
                classics to the latest releases, Arcadia brings you the best in
                entertainment. Dive into a universe of adventures, challenges,
                and endless fun. Are you ready to play?
              </h5>
              {/* Chamada para ação para criar uma conta */}
              <h6 className="font-bold md:mt-8 text-sm md:text-base">
                Create Your Free Account & Start Playing
              </h6>
            </div>
